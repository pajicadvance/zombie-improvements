...
public abstract class LivingEntityRendererMixin<S extends LivingEntityRenderState, M extends EntityModel<? super S>> {
    ...
    private boolean renderZombiePowerLayer(
        ...
        if (
				ZombieImprovements.CONFIG.leaderRedAura.get() && renderState.entityType != null &&
				renderState.entityType.builtInRegistryHolder().is(EntityTypeTags.ZOMBIES) &&
				renderState instanceof HumanoidRenderState &&
				((HumanoidRenderStateExtension) renderState).zi$isLeader()
		) {
